...
The keys live in `.claude/settings.json` (project) or `/Users/dallask/Projects/learn/Claude Black Belts Training/inventory-management/.claude/settings.json` (global) — **not** in `.planning/config.json`:
