...
<template>
@/Users/dallask/Projects/learn/Claude Black Belts Training/inventory-management/.claude/gsd-core/templates/UAT.md
</template>
...
**MVP-mode UAT framing.** When `MVP_MODE=true`, follow the rules in `@/Users/dallask/Projects/learn/Claude Black Belts Training/inventory-management/.claude/gsd-core/references/verify-mvp-mode.md`. Briefly:
...
Read and follow `/Users/dallask/Projects/learn/Claude Black Belts Training/inventory-management/.claude/gsd-core/workflows/transition.md`.
...
- Follow @/Users/dallask/Projects/learn/Claude Black Belts Training/inventory-management/.claude/gsd-core/workflows/diagnose-issues.md
