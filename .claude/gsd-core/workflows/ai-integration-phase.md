...
<required_reading>
@/Users/dallask/Projects/learn/Claude Black Belts Training/inventory-management/.claude/gsd-core/references/ai-frameworks.md
@/Users/dallask/Projects/learn/Claude Black Belts Training/inventory-management/.claude/gsd-core/references/ai-evals.md
</required_reading>
...
```markdown
Read /Users/dallask/Projects/learn/Claude Black Belts Training/inventory-management/.claude/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "/Users/dallask/Projects/learn/Claude Black Belts Training/inventory-management/.claude/gsd-core/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read /Users/dallask/Projects/learn/Claude Black Belts Training/inventory-management/.claude/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read /Users/dallask/Projects/learn/Claude Black Belts Training/inventory-management/.claude/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read /Users/dallask/Projects/learn/Claude Black Belts Training/inventory-management/.claude/agents/gsd-eval-planner.md for instructions.
