...
ones). Reference: @/Users/dallask/Projects/learn/Claude Black Belts Training/inventory-management/.claude/gsd-core/references/edge-probe.md.
...
# — NOT the consuming project's git root — falling back to git toplevel / /Users/dallask/Projects/learn/Claude Black Belts Training/inventory-management/.claude.
...
EDGE_PROBE_JS=$(for _c in \
  ...
  "/Users/dallask/Projects/learn/Claude Black Belts Training/inventory-management/.claude/gsd-core/bin/lib/edge-probe.cjs" \
  "/Users/dallask/Projects/learn/Claude Black Belts Training/inventory-management/.claude/bin/lib/edge-probe.cjs"; do
  [ -f "$_c" ] && { echo "$_c"; break; }
done)
...
requirement list). Reference: @/Users/dallask/Projects/learn/Claude Black Belts Training/inventory-management/.claude/gsd-core/references/prohibition-probe.md — the
...
Use the SPEC.md template from @/Users/dallask/Projects/learn/Claude Black Belts Training/inventory-management/.claude/gsd-core/templates/spec.md.
