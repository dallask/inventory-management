...
Key references:
- @/Users/dallask/Projects/learn/Claude Black Belts Training/inventory-management/.claude/gsd-core/references/ui-brand.md (display patterns)
- @/Users/dallask/Projects/learn/Claude Black Belts Training/inventory-management/.claude/agents/gsd-user-profiler.md (profiler agent definition)
- @/Users/dallask/Projects/learn/Claude Black Belts Training/inventory-management/.claude/gsd-core/references/user-profiling.md (profiling reference doc)
</required_reading>
...
```bash
PROFILE_PATH="/Users/dallask/Projects/learn/Claude Black Belts Training/inventory-management/.claude/gsd-core/USER-PROFILE.md"
...
```bash
cp "/Users/dallask/Projects/learn/Claude Black Belts Training/inventory-management/.claude/gsd-core/USER-PROFILE.md" "/Users/dallask/Projects/learn/Claude Black Belts Training/inventory-management/.claude/USER-PROFILE.backup.md"
```
...
✓ Stores profile at /Users/dallask/Projects/learn/Claude Black Belts Training/inventory-management/.claude/gsd-core/USER-PROFILE.md
...
- The user-profiling reference doc at `/Users/dallask/Projects/learn/Claude Black Belts Training/inventory-management/.claude/gsd-core/references/user-profiling.md`
...
Reference: @/Users/dallask/Projects/learn/Claude Black Belts Training/inventory-management/.claude/gsd-core/references/user-profiling.md
...
Display: "✓ Profile written to /Users/dallask/Projects/learn/Claude Black Belts Training/inventory-management/.claude/gsd-core/USER-PROFILE.md"
...
- options (ALL pre-selected by default):
  ...
  - "Global CLAUDE.md" -- "Add profile to /Users/dallask/Projects/learn/Claude Black Belts Training/inventory-management/.claude/CLAUDE.md for all projects"

**If no artifacts selected:** Display "No artifacts generated. Your profile is saved at /Users/dallask/Projects/learn/Claude Black Belts Training/inventory-management/.claude/gsd-core/USER-PROFILE.md" and jump to step 10.
...
Display: "✓ Generated /gsd-dev-preferences at /Users/dallask/Projects/learn/Claude Black Belts Training/inventory-management/.claude/skills/gsd-dev-preferences/SKILL.md"
...
Display: "✓ Added profile section to /Users/dallask/Projects/learn/Claude Black Belts Training/inventory-management/.claude/CLAUDE.md"
...
```bash
BACKUP_PATH="/Users/dallask/Projects/learn/Claude Black Belts Training/inventory-management/.claude/USER-PROFILE.backup.md"
```
...
Your profile:    /Users/dallask/Projects/learn/Claude Black Belts Training/inventory-management/.claude/gsd-core/USER-PROFILE.md
```

Then list paths for each generated artifact:
```
Artifacts:
  ✓ /gsd-dev-preferences   /Users/dallask/Projects/learn/Claude Black Belts Training/inventory-management/.claude/skills/gsd-dev-preferences/SKILL.md
  ✓ CLAUDE.md section       <resolved claude_md_path, default ./.claude/CLAUDE.md>
  ✓ Global CLAUDE.md        /Users/dallask/Projects/learn/Claude Black Belts Training/inventory-management/.claude/CLAUDE.md
```
