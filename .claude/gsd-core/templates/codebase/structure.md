...
- Usage: Reference from command with `@/Users/dallask/Projects/learn/Claude Black Belts Training/inventory-management/.claude/gsd-core/workflows/{name}.md`
...
**gsd-core/**
- Purpose: Resources installed to /Users/dallask/Projects/learn/Claude Black Belts Training/inventory-management/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /Users/dallask/Projects/learn/Claude Black Belts Training/inventory-management/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
